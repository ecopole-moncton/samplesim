...
[**siar**](https://github.com/AndrewLJackson/siar) or the 
package [**MixSIAR**](https://cran.r-project.org/web/packages/MixSIAR/index.html) or simmr (https://cran.r-project.org/web/packages/simmr/vignettes/simmr.html). 
...
- the isotopic values of the consumers;
- the isotopic values of the preys (also called sources);
